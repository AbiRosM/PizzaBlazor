    ...
    public class CuentasController : ControllerBase
    {
        ...
        private UserToken BuildToken(UserInfo userInfo)
        {
            var claims = new List<Claim>()
            {
                ...
                new Claim("Password", userInfo.UserName), //Esto es solo para demostrar que se puede agregar lo que quiera
            //Ojo, no se debe agregar informacion sensible en los claims, ya que estos se pueden robar
